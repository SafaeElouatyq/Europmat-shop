...
export const Productsgrid = () => {
  ...
  return (
    <div id='Products' className='w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
      <h1 data-aos="zoom-in" data-aos-delay="100" className='text-themepurple test-xl font-semibold'>Browse Collections</h1>
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold test-[42px] leading-[50px] text-center'>Trending Products</h1>
      ...
      products.map((item,index)=>(
        <div id='products-box' key={index} className="flex flex-col justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative">
          ...
          <h1 className='text-themepurple font-semibold'>{item.price}</h1>
      ...
      <button data-aos="zoom-on" data-aos-delay="400" className='bg-themepurple hover:bg-themeyellow text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8'>VIEW MORE</button>
    </div>
  )
}
