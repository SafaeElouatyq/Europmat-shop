...
export const Reviews = () => {
  ...
  return (
    <div id='testimonials' className='w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
      ...
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold text-[42px] leading-[50px] text-center capitalize'>Our Costomer Love</h1>
      <div data-aos="zoom-in" data-aos-delay="300" className="w-full mt-10 ">
        <Slider className='w-full' {...settings}>
            {
              reviewdata.map((item,index)=>(
                <div className="">
                  <div key={index} className="w-full flex-col justify-center items-center gap-4 lg:p-10 p-3">
                    ...
                    <div className="flex justify-center items-center gap-5">
                        <FaQuoteLeft className='fill-themepurple size-16'></FaQuoteLeft>
                    </div>
